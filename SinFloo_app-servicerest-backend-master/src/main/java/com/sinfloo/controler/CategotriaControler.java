...
import com.sinfloo.service.CategoriaService;

@RestController
@RequestMapping("/categorias")
public class CategotriaControler {
	...
	@PostMapping("/agregar")
	public String save(@RequestBody Categoria  cat,Model model) {
	...
	public String save(@RequestBody Categoria cat,@PathVariable int id,Model model) {
